...
export const ProductVariationContentQueryByNameExample: React.FunctionComponent<{
  productVariationName?: string;
}> = (props) => {
  const {
    productVariationName = mockMenuItemProduct.AMERICANO.productVariationIds[0]!
      .name,
  } = props;
